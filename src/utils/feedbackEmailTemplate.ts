  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center" style="padding:24px;">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#111827;border-radius:16px;overflow:hidden;">

          <!-- HEADER -->
          <tr>
            <td style="padding:20px 24px;background:linear-gradient(135deg,#374151,#aeb7c2);color:#d9ebe7;">
            ...
            <td style="padding:20px 24px;color:#d9ebe7;font-size:14px;">
              <table width="100%" cellpadding="6" cellspacing="0">
                ...
                <tr>
                  ...
                  <td>
                    <a href="mailto:${data.email}" style="color:#8ccf2f;text-decoration:none;">
                      ${data.email}
                    </a>
                  </td>
                </tr>
          ...
          <!-- MESSAGE -->
          <tr>
            <td style="padding:20px 24px;background:#374151;">
              <div style="background:#374151;border:1px solid #8ccf2f;border-radius:12px;padding:16px;color:#d9ebe7;font-size:14px;line-height:1.6;">
          ...
          <!-- FOOTER -->
          <tr>
            <td style="padding:16px 24px;text-align:center;color:#8ccf2f;font-size:12px;">
