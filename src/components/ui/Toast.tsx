...
export const Toast = ({ type, message, duration, progress, onClose }: ToastItemType) => {
  ...
  const toastTypeStyles: Record<ToastType, string> = {
    success: 'bg-toast-success-bg border-toast-success-border text-toast-success-foreground',
    error: 'bg-toast-error-bg border-toast-error-border text-toast-error-foreground',
  };
